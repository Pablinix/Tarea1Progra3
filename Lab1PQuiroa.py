...
entrada_usuario = input("Ingresa un valor: ")

tipo_de_dato = determinar_tipo_de_dato(entrada_usuario)

print(f"El tipo de dato ideal para esta variable es: {tipo_de_dato}")
